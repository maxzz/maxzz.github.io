...
function ProjectTile({ caption, description, urlGithub, urlDemo, previewUrl, }: ProjectType) {
    return (
        <section className="flex flex-col">
            ...
            <div className="flex-1 p-4 grid grid-rows-[1fr_auto] grid-cols-[1fr_auto] gap-x-4 gap-y-2 bg-slate-800 rounded">
...
function Section({ section }: { section: SectionType; }) {
    return (
        <div className="w-full max-w-7xl">
            ...
            <div className="mx-4 grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))] gap-2 overflow-y-auto">
