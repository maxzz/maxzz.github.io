...
export const projectsTemplates: ProjectType[] = [
    {
        primary: 'templates',
    ...
    {
        primary: 'templates',
        id: "tm-template-go-26",
        description: "An interactive playground for exploring the use of CSS colors in shadcn",
        urlGithub: "https://github.com/maxzz/tm-template-go-26",
        urlDemo: "https://maxzz.github.io/tm-template-go-26",
        urlPreview: images.templateShadcn26,
        localPath: "C:/y/w/2-web/0-stack/0-templates/tm-template-go-26",
        stack: ['react', 'go', 'shadcn', 'jotai', 'valtio'],
    },
    {
        primary: 'templates',
        id: "tm-template-go-26-simple",
        description: "An interactive playground for exploring the use of CSS colors in shadcn",
        urlGithub: "https://github.com/maxzz/tm-template-go-26-simple",
        urlDemo: "https://maxzz.github.io/tm-template-go-26-simple",
        urlPreview: images.templateGo26,
        localPath: "C:/y/w/2-web/0-stack/0-templates/tm-template-go-26-simple",
        stack: ['react', 'go', 'ts', 'tw', 'shadcn', 'jotai', 'valtio'],
    },
];
